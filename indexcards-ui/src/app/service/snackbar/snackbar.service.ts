...
export class SnackbarService {
  ...
  public showHttpError(err: HttpErrorResponse): void {
    this.snackBar.open(
      `${this.translateService.instant(`common.error`)}: ${this.translateService.instant(`backend.${err.error}`)}`,
      'Ok',
      {
        duration: 3000,
      },
  ...
  public showErrorMessage(key: string): void {
    this.snackBar.open(
      this.translateService.instant(`common.error`) + ': ' + this.translateService.instant(key),
      'Ok',
      {
        duration: 3000,
      },
  ...
  public showSuccessMessage(key: string): void {
    this.snackBar.open(
      this.translateService.instant(`common.success`) + ': ' + this.translateService.instant(key),
      'Ok',
      {
        duration: 3000,
      },
  ...
  public showWarnMessage(key: string): void {
    this.snackBar.open(
      this.translateService.instant(`common.warn`) + ': ' + this.translateService.instant(key),
      'Ok',
      {
        duration: 3000,
      },
