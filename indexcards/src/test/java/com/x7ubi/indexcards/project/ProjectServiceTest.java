...
public class ProjectServiceTest extends ProjectTestConfig {
    ...
    public void getUserProjectWithWrongProjectIdTest() {
        ...
        // then
        assertEquals(WRONGFULLY_UNSUCCESSFUL, userProjectResponse.isSuccess(), false);
        assertEquals(WRONG_NUMBER_OF_ERRORS, userProjectResponse.getErrorMessages().size(), 1);
        assertEquals(WRONG_NUMBER_OF_ERRORS, userProjectResponse.getErrorMessages().get(0).getMessage(), ErrorMessage.Project.PROJECT_NOT_FOUND);
